...
class UserCluster:
    ...
    def dim_reduction(self):
        ...
        with open(Parameter.reduced_mat_path, 'wb') as f:
    ...
    def train(self):
        ...
        for i in tqdm(range(epoch)):
            ...
            self.Mstep()
        with open(Parameter.EM_mu_sigma_alpha_path, 'wb') as f:
...
class BagUserCluster:
    ...
    def recommand(self, test_rating):
        print("Recommanding...")
        with open(os.path.join(Parameter.output_root, "output_cluster.txt"), "w") as file:
